<?php 
    ...
    && isset($_POST['infoarm']) && isset($_POST['inforu']) && isset($_POST['infoeng']) && isset($_POST['cat-id'])){
            ...
            if(!empty($_FILES['file1']) && !empty($_FILES['file2']) && !empty($_FILES['file3']) && !empty($_FILES['file4'])){
                ...
                `width`,`useful_width`,`length`,`incategory`) VALUES ('$cat_name_arm','$cat_name_ru','$cat_name_eng',
                '$name1','$name2','$name3','$name4','$infoarm','$inforu','$infoeng',
                '$hastutyun','$laynutyun','$ogt_laynutyun','$erkarutyun',$catid)");
